...
import (
	...
	storage2 "github.com/deeploop-ai/graviton/internal/app/storage"
...
func wireBootstrap(app lynx.Lynx) (*boot.Bootstrap, func(), error) {
	...
	account := client.NewAccount(appConfig, projectsRepository, oAuthProviderRepository, documentDB, sessionService, redisOTPChallengeStore, redisOAuthStateStore, mailerService, smsService)
